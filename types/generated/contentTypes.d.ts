...
export interface ApiHomeBannerHomeBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    home_banner_background: Schema.Attribute.Media<
      'images' | 'files' | 'videos'
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
    ...
    home_banner_image: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    home_banner_subtitle: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    home_banner_title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    read_more_button: Schema.Attribute.Component<'button.read-more', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<
      ['content.basic-content', 'content.content-section']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
